...
function FreeboardModel(a, b, c) {
    ...
    this.version = 0, this.isEditing = ko.observable(!1), this.allow_edit = ko.observable(!1), this.allow_edit.subscribe(function(a) {
        ...
        function g() {
            c.setUserColumns(e.columns), d.allow_edit(_.isUndefined(e.allow_edit) ? !0 : e.allow_edit), d.version = e.version || 0, d.header_image(e.header_image), _.each(e.datasources, function(b) {
        ...
        } else alert("Unable to load a file in this browser.")
    }, this.saveDashboard = function() {
        var a = "application/octet-stream",
            b = document.createElement("a"),
            c = new Blob([JSON.stringify(d.serialize())], {
                type: a
            });
        document.body.appendChild(b), b.href = window.URL.createObjectURL(c), b.download = "bimarian_final.json", b.target = "_self", b.click()
    }, this.addDatasource = function(a) {
        d.datasources.push(a)
    }, this.deleteDatasource = function(a) {
        delete d.datasourceData[a.name()], a.dispose(), d.datasources.remove(a)
...
function WidgetModel(a, b) {
    ...
    this.datasourceRefreshNotifications = {}, this.calculatedSettingScripts = {}, this.title = ko.observable(), this.fillSize = ko.observable(!1), this.type = ko.observable(), this.type.subscribe(function(a) {
        ...
        if (_.isFunction(d.calculatedSettingScripts[a])) {
            ...
            if (!_.isUndefined(d.widgetInstance) && _.isFunction(d.widgetInstance.onCalculatedValueChanged) && !_.isUndefined(b)) try {
...
DatasourceModel = function(a, b) {
        ...
        function f(c, d, e, f, g) {
            ...
            h.change(e.multi_input ? function() {
                var a = [];
        ...
        function g(a, b, g, h, i) {
                            ...
                            if (m.settings[a.name] = h[a.name], "calculated" == a.type) {
                                if (a.name in h) {
                                    ...
                                    if (a.multi_input && _.isArray(u))
                                        for (var v = !1, w = 0; w < u.length; w++) f(i, m, a, u[w], v), v = !0;
                                    else f(i, m, a, u, !1)
                                } else f(i, m, a, null, !1);
                                if (a.multi_input) {
            ...
            n.append(o), new DialogBox(n, a, "Save", "Cancel", function() {
                ...
                for (var a = 0; a < l.settings.length; a++) {
                    var b = l.settings[a];
                    if (b.required && (_.isUndefined(m.settings[b.name]) || "" == m.settings[b.name])) return c(b.name, "This is required."), !0;
                    if ("number" == b.type && !e(m.settings[b.name])) return c(b.name, "Must be a number."), !0
                }
                _.isFunction(i) && i(m)
            });
            var p, q = _.keys(b);
            ...
            } else 1 == q.length && (l = b[q[0]], m.type = l.type_name, m.settings = {}, k(l.settings));
        ...
        function f(a, c, d) {
            ...
            if (e)
                ...
                if (!_.isUndefined(h)) {
                    ...
                    } else _.isObject(o) && _.each(o, function(a, c) {
        ...
        function g(b, c) {
            ...
            } else d(b, c), $(b).next("ul#value-selector").remove(), k = null, l = -1
        }
        ...
        function i(a, b) {
            $(a).addClass("calculated-value-input").bind("keyup mouseup freeboard-eval", function(c) {
                ...
                if (k)
                    ...
                    } else 13 == a.keyCode && (a.preventDefault(), -1 != l && $(k).find("li").eq(l).trigger("freeboard-insertValue"))
            })
        }
...
var freeboard = function() {
    ...
    return ko.bindingHandlers.pluginEditor = {
            ...
            "datasource" == k.type ? (l = b, n = "Datasource") : "widget" == k.type ? (l = c, n = "Widget") : "pane" == k.type && (n = "Pane"), $(a).click(function(f) {
                if ("delete" == k.operation) {
                    ...
                    "datasource" == k.type ? "add" == k.operation ? m = {} : (j = i.type(), m = i.settings(), m.name = i.name()) : "widget" == k.type ? "add" == k.operation ? m = {} : (j = i.type(), m = i.settings()) : "pane" == k.type && (m = {}, "edit" == k.operation && (m.title = i.title(), m.col_width = i.col_width()), l = {
                        ...
                        } else "edit" == k.operation && ("pane" == k.type ? (i.title(f.settings.title), i.col_width(f.settings.col_width), d.processResize(!1)) : ("datasource" == k.type && (i.name(f.settings.name), delete f.settings.name), i.type(f.type), i.settings(f.settings)))
                    })
                }
            })
        }
        ...
        init: function(a, b, c, f, g) {
            e.isEditing() && d.attachWidgetEditIcons($(a).parent())
        },
        update: function(a, b, c, d, e) {
            d.shouldRender() && ($(a).empty(), d.render(a))
        }
    }, $(function() {
        function a() {
            d.processResize(!0)
        ...
        setDatasourceSettings: function(a, b) {
            ...
            if (!d) return void console.log("Datasource not found");
...
$.extend(freeboard, jQuery.eventEmitter),
    function() {
        ...
        var b = function(a, b) {
            ...
            c(1e3 * g.refresh), this.updateNow = function() {
                $.ajax({
                    url: "http://api.openweathermap.org/data/2.5/weather?q=" + encodeURIComponent(g.location) + "&units=" + g.units,
                    dataType: "JSONP",
                    success: function(a) {
                        var c = {
                            place_name: a.name,
    ...
    function() {
        ...
        var m = function(a) {
            function b() {
                e.toggleClass("on", g), d.text(g ? _.isUndefined(f.on_text) ? "" : f.on_text : _.isUndefined(f.off_text) ? "" : f.off_text)
            }
            var c = $('<h2 class="section-title"></h2>'),
                d = $('<div class="indicator-text"></div>'),
                e = $('<div class="indicator-light"></div>'),
                f = a,
                g = !1;
            this.render = function(a) {
                $(a).append(c).append(e).append(d)
            }, this.onSettingsChanged = function(a) {
                f = a, c.html(_.isUndefined(a.title) ? "" : a.title), b()
            }, this.onCalculatedValueChanged = function(a, c) {
                "value" == a && (g = Boolean(c)), b()
            }, this.onDispose = function() {}, this.getHeight = function() {
                return 1
            }, this.onSettingsChanged(a)
        };
