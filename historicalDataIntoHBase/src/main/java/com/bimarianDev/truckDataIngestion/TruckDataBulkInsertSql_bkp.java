...
public class TruckDataBulkInsertSql_bkp  implements Serializable {
	...
	public static void main(String[] args) throws  FileNotFoundException {
		...
		String inputFilePath = "hdfs://hadoop1.test.com:8020/user/root/bhanu/datagen0910_vrl_service_12060100122_6MONdata_hyd_Chilukur_linux.json";
		...
		JavaSchemaRDD shemaRDD = sqlContext.jsonFile(inputFilePath,schema);
